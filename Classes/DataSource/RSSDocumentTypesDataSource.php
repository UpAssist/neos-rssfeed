...
class RSSDocumentTypesDataSource extends AbstractDataSource
{
    /**
     * @var array
     * @Flow\InjectConfiguration(path="allowedDocumentTypes", package="UpAssist.Neos.RSSFeed")
     */
     ...
     * @var string
     */
    static protected $identifier = 'rss-documenttypes';
